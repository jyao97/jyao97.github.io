...
{% for item in site.data.news %}
  {% if item.pinned %}
  <li style="list-style-type: '📌  ';">{{ item.date }}: {{ item.text }}</li>
  {% endif %}
{% endfor %}
{% for item in site.data.news %}
  {% unless item.pinned %}
...
<div class="experience-cards">
  <div class="card">
    ...
    <div class="card-content">
      ...
      <p><strong>Advisor:</strong> Prof. <a href="https://hangqiu.github.io/">Hang Qiu</a></p>
    </div>
